...
/***/ function(module, exports, __webpack_require__) {
	...
	// dom.hasStyling to all block parents and if one does insert a br
				var DUPLICATED_TAGS = 'code,blockquote,hide,pre';
	...
	var __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_RESULT__ = function (require) {
		...
		var dom = {
			...
			blockLevelList: '|body|hr|p|div|h1|h2|h3|h4|h5|h6|address|pre|form|' +
				'table|tbody|thead|tfoot|th|tr|td|li|ol|ul|blockquote|hide|center|',
	...
	var __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_RESULT__ = function (require) {
		...
		return {
			...
			toolbar: 'bold,italic,underline,strike,subscript,superscript|' +
				...
				'table|code,quote,hide|horizontalrule,image,email,link,unlink|' +
